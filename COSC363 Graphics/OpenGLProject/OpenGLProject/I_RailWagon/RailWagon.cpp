...
{
	if(key==GLUT_KEY_LEFT) angle+=3;        //Rotate wagon
	else if(key==GLUT_KEY_RIGHT) angle-=3;
...
void wagon()
{
	...
	glBegin(GL_QUADS);
	  ...
	  glTexCoord2f(1., (87.0/256));	 glVertex3f(35.0, 17.0, 6.0);
	  glTexCoord2f(0., (87.0/256));	 glVertex3f(-35.0, 17.0, 6.0);
	  ...
	  glTexCoord2f(0., (115.0 / 256)); glVertex3f(-35.0, 17.0, 6.0);
	  glTexCoord2f(1., (115.0 / 256)); glVertex3f(35.0, 17.0,  6.0);
	  glTexCoord2f(1., (212.0 / 256)); glVertex3f(35.0, 17.0, -6.0);
	  glTexCoord2f(0., (212.0 / 256)); glVertex3f(-35.0, 17.0, -6.0);
	glEnd();
