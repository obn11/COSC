...
class LocationGraph(ExplicitGraph):
	...
	def calc_cost(self, tail, head):
		return (((self.locations.get(tail)[0] - self.locations.get(head)[0])**2) + ((self.locations.get(tail)[1] - self.locations.get(head)[1])**2))**0.5
